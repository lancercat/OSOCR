...
if modelfile.endswith('.bin.gz'):
    model = gensim.castle_models.KeyedVectors.load_word2vec_format(modelfile, binary=True)
else:
    model = gensim.castle_models.KeyedVectors.load_word2vec_format(modelfile, binary=False)
