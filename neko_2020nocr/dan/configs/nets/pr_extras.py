...
from neko_2020nocr.dan.dan_modules.neko_os_DTD_mk4_cclcf import neko_os_DTD_mk4_cclcf,\
     neko_os_DTD_mk4_scosine_cclcf,neko_os_DTD_mk4_paramrej_cclcf;
...
def get_dos_basic_cco_param_rej(ptfile,prefix,token,maxT=25,root_override=None,val_frac_override=0.8):
    return get_dos_cco(neko_cco_Feature_Extractor,CAM,neko_os_DTD_mk4_paramrej_cclcf,neko_SDPE2,ptfile,prefix,token,0.5,maxT,root_override=root_override,val_frac_override=val_frac_override);

### Similar to Prototypical Matching and Open Set Rejection for Zero-Shot Semantic Segmentation
def get_dos_basic_ccorgb_thicc_param_rej(ptfile,prefix,token,maxT=25,root_override=None,val_frac_override=0.8):
    return get_dos_cco_rgb(neko_cco_Feature_Extractor_thicc,CAM,neko_os_DTD_mk4_paramrej_cclcf,neko_SDPE2,ptfile,prefix,token,0.5,maxT,root_override=root_override,val_frac_override=val_frac_override);
