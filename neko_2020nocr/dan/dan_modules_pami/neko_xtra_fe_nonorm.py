...
'''
class neko_cco_Feature_Extractor_thicc_no_norm(nn.Module):
    def __init__(self, strides, compress_layer, input_shape,hardness=2,oupch=512):
        super(neko_cco_Feature_Extractor_thicc_no_norm, self).__init__()
        self.model = rescco.res_naive_lens45_thicc_nn(strides, compress_layer,hardness,oupch=oupch,inpch=input_shape[0])
