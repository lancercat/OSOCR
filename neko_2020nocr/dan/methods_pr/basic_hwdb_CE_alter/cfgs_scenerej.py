...
from neko_2020nocr.dan.methods_pr.HWDBS_cfg import *
...
class scene_cfg:
    def __init__(this):
        dataset = DSCFG(cnt, T, "dictrej.pt", DSROOT);
...
class scene_cfg_te(scene_cfg):
    def __init__(this,pathoveride,rejdictpath):
        dataset = DSCFG(cnt, T,rejdictpath , DSROOT);
        PDICT = dataset["dict_dir"];
