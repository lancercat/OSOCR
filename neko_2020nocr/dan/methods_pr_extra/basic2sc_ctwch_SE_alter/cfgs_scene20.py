...
from neko_2020nocr.dan.configs.nets.pr_extras import get_dos_basic_cco_scosine as get_net;
from neko_2020nocr.dan.methods_pr.CTWS_cfg import *
from neko_2020nocr.dan.methods_pr.loss_cfg import sim_emb as loss;
cnt=2000
prefix="basic2sc"+"_"+DSPRFIX+"_"+loss[0]+"_"+"alter_"+str(cnt);
print(prefix);
