...
from neko_sdk.ocr_modules.charset.etc_cset import korean
from neko_sdk.ocr_modules.charset.chs2trd import chs37552cpx;
def make_chlatkr_mc_dict(font,protodst,xtracs=set()):
    # cpx=[];
    # for i in chs37552cpx.values():
    #     cpx+=i;
    chrset=list(t1_3755)+list(set("QWERTYUIOPASDFGHJKLZXCVBNMqwertyuiopasdfghjklzxcvbnm1234567890"))+list(korean)+list(xtracs);
...
if __name__ == '__main__':
    ...
    make_chlatkr_mc_dict(font,protodst)